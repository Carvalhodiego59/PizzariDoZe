...
namespace PizzariaDaBiblioteca.DAO
{
    public class ProdutoDAO
    {
        ...
        public DataTable Buscar(Produto produto)
        {
            ...
            conexao.Open();
            comando.CommandText = @" " +
            "SELECT id_produto AS ID, descricao_produto AS Descrição, valor AS Valor, tipo AS 'Tipo Produto'," +
            "medida_unitaria AS ML " + "FROM cad_produtos AS p " + auxSqlFiltro + "ORDER BY p.descricao_produto;";
