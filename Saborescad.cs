...
{
    public partial class Saborescad : Form
    {
        ...
        private void ButtonPdfSelecionado_Click(object sender, EventArgs e)
        {
            if (dataGridViewDados.SelectedCells.Count <= 0)
            {
            ...
            DataGridViewRow selectedRow = dataGridViewDados.Rows[dataGridViewDados.SelectedCells[0].RowIndex];
            int id = Convert.ToInt32(selectedRow.Cells[0].Value);
            string pathArquivo = ClassGeraPdf.pathArquivo("RelSabor");
